...
// passed an array of elements to be removed and an array full of elements
// the array contains string - no numbers, no special character either

// return the array with strings as elements aand the geese removed

function gooseFilter (birds){
    const geese = ["African", "Roman Tufted", "Toulouse", "Pilgrim", "Steinbacher"]

    // takes array birds and filter out array geese and return
